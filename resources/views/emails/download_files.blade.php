...
<div>
  <div style="background-image: url({{ asset('img/reportes/Rectangulo2.png') }}); height:521px;width:512px;top: 40px;z-index: -1; margin:0 auto;">
   <div style="text-indent:40px;line-height:0px">
    ...
    <h1 style="width: 397px;color: #373737;font-family: Roboto, sans-serif;font-size: 25px;font-weight: bold;text-indent:40px; ">¡Tu archivos están listos! </h1>
    <br>
    <div style="text-indent:40px;text-align:justify;font-family: Roboto, sans-serif;font-size: 16px;line-height: 24px;">Hola, los archivos  <b><?php //echo $nombre_cuenta; ?></b> que has solicitado se encuentra  </div>
    <div style="text-indent:40px;text-align:justify;font-family: Roboto, sans-serif;font-size: 16px;line-height: 24px;"> están listos para ser descargados. </div><p>
    <div style="text-indent:40px;text-align:justify;font-family: Roboto, sans-serif;font-size: 16px;line-height: 24px;"> Para poder acceder a ellos, haz click en el siguiente</a>
    ...
    <div style="text-indent:40px;text-align:justify;font-family: Roboto, sans-serif;font-size: 16px;line-height: 24px;">Una vez que hagas la descarga, </div>
