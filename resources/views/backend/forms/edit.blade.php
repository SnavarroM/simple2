...
@section('content')
                    ...
                    <form id="formEditarFormulario" class="form-horizontal dynaForm debugForm" onsubmit="return false">
                        <div class="row">
                            <div class="col-10 text-left">
                                <legend class="name-form" id="leyend-edit-form"><?= $formulario->nombre ?></legend>
    ...
    <div class="modal hide" id="modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true"></div>
@endsection
@section('script')
