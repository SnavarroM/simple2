...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            drawSeguimiento(<?= json_encode($tramite->getTareasActuales()->toArray(false)) ?>,<?= json_encode($tramite->getTareasCompletadas()->toArray(false)) ?>, <?= json_encode($tramite->getTareasVencidas()->toArray(false)) ?>, <?= json_encode($tramite->getTareasVencenHoy()->toArray(false)) ?>);
        });
