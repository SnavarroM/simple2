...
class ValidatorController extends Controller
{
    ...
    public function documento(Request $request)
    {
        ...
        $historial_consulta = new HistorialConsulta();
        $historial_consulta->user_agent = $request->header('User-Agent');
        $historial_consulta->file_id = $file->id;
        $historial_consulta->created_at = Carbon::now()->format('Y-m-d H:i:s');
        $historial_consulta->save();
