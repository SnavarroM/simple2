...
class UsuarioBackend extends Authenticatable
{
    ...
    {
        return $this->belongsTo(Cuenta::class)->withTrashed();
    }
    ...
    public function sendPasswordResetNotification($token)
    {
        ...
        // $varurl = route('backend.password.reset.get', [$token,  $this->email]);
    ...
    public function procesos_permiso()
    {
        return $this->belongsToMany('App\Models\Proceso', 'proceso_permiso', 'usuario_id', 'proceso_id');
    }
}
