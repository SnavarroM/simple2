    ...
    */
    ...
    private function render($identifier, $key, $etapa_id = null, $filename = false, $copia = false)
    {
        ...
        if ($this->tipo == 'certificado') {
            ...
            if ($this->sello_agua && file_exists(public_path('uploads/sello_agua/' . $this->sello_agua))) {
                $obj->sello_agua = 'uploads/sello_agua/' . $this->sello_agua;
            }
