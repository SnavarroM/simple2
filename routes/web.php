...
//    Route::get('/terminos-y-condiciones', 'HomeController@terminosFront')->name('front.terminos');
    ...
    Route::get('/etapas/away/{etapa_id}', 'StagesController@ejecutar_away')->name('stage.ejecutar_away');
    ...
    Route::middleware('auth:usuario_backend')->group(function () {
        ...
        //Route::middleware('check_terms')->group(function () {
            ...
            Route::middleware('can:gestion')->group(function () {
                ...
                Route::get('reportes/zona_descarga/{user_id}/{job_id}/{file_name}', 'ReportController@preDescarga')->name('report.pre_descargar');
            });
...
Route::prefix('manager')->namespace('Manager')->name('manager.')->group(function () {
    ...
    Route::middleware('auth:usuario_manager')->group(function () {
        ...
        Route::get('/cuentas/habilitar/{cuenta_id?}', 'AccountController@habilitar')->name('account.habilitar');
        ...
        Route::get('/usuarios/procesos/{cuenta_id?}', 'UsersController@getProcesos')->name('users.get_procesos');
        ...
        // Usuarios Frontend
        Route::get('/frontend/cuentas', 'UserFrontendController@index')->name('cuentasfrontend.index');
        Route::get('/frontend/{cuenta_id?}/usuarios', 'UserFrontendController@get_usuarios')->name('userfrontend.index');
